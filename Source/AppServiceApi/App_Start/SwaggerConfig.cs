...
namespace AppServiceApi
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.IncludeXmlComments(GetXmlInputCommentsPath());
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        c.CustomAsset("index", thisAssembly, "AppServiceApi.doc.html.index.html");
        ...
        {
            return System.String.Format(@"{0}\bin\AppServiceApi.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
        protected static string GetXmlInputCommentsPath()
        {
            return System.String.Format(@"{0}\bin\AppServiceApi.Core.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
        ...
        private static string ResolveBasePath(HttpRequestMessage message)
        {
            ...
            if (message.RequestUri.Host.Contains("iazi.ch") && (message.RequestUri.Port == 80 || message.RequestUri.Port == 443))
            {
                return string.Format("{0}://{1}:{2}{3}", "https", message.RequestUri.Host, "443", virtualPathRoot);
            }
            else
            {
